# in equation 4 in the research paper, using keras there is no exact way to specify some weights to be untrainable. ( only layers are able to be defined untrainable)
